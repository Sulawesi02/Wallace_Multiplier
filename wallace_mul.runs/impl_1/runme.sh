...
HD_PWD='D:/Mycode/vivadoCode/wallace_mul/wallace_mul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wallace.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wallace.tcl -notrace
